...
<?php if ($totalRows_geral > 0): ?>
    ...
    ?>> 
        <td width="24%"> <div align="center"><font color="#FF0000"><strong><font color="#000066"><?php echo htmlspecialchars($row_geral['desc_tipo_doc']); ?></font></strong>&nbsp;</font></div>
        ...
        <td width="76%" align="left" valign="top"><font color="#0000FF"><strong>assunto</strong>:</font>&nbsp;<?php echo htmlspecialchars($row_geral['assunto']); ?> <br> <div align="left"><font color="#0000FF"><strong>DESTINO</strong>:</font> 
    ...
    <?php } while ($row_geral = mysqli_fetch_assoc($geral_result)); ?>
<?php endif; ?>
...
<?php
mysqli_free_result($geral_result);
